"""
From https://github.com/PoonLab/covizu, vsportal branch
Retrieve SARS-CoV-2 genome data from VirusSeq data portal (Canada)
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Download data from VirusSeq portal database,"
                                     "re-compressing streams to reduce file size.")
