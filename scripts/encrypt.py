# adapted from https://github.com/MaxLaumeister/PageCrypt/blob/master/python
# requires the "encryptTemplate.html" file in the scripts directory.
# this script should be ran in the root folder. 
try:
...
def main():
	...
	with open(os.path.join(projectFolder, "scripts", "encryptTemplate.html")) as f:
		templateHTML = f.read()
