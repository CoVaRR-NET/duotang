...
meta <- read.csv(gzfile(paste0(params$datadir, "gsd.metadata.tsv.gz")), sep="\t")
...
startdate<-max(meta$sample_collection_date,na.rm = TRUE)-days(120) #Using a later date with less sampling noise
