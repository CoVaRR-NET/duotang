...
sublineage_kp1 <- getStrictoSubLineages("KP.*",meta)
...
mutantNames = list("XBB", "KP.*","BA.2.Other",  "JN.1*") #
col <- c("XBB"=pal["XBB"], "KP.*" = "#00eeff","BA.2.Other*"="#CC5500") #define custom color for XBB here because otherwise it will be black cuz recombinant.
