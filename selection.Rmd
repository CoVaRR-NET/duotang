...
sublineage_LP811 <- getStrictoSubLineages("LP.8.1.1*",meta)
...
mutantNames = list("MC*", "LP.8.8.1*","Others",  "XEC*") #
col <- c("MC*"=pal["XBB"], "LP.8.8.1*" = "#00eeff","Others"="#CC5500") #define custom color for XBB here because otherwise it will be black cuz recombinant.
