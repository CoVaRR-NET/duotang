...
mutantNames = list("XBB.1.5*", "XBB\U200B.1.16*", "XBB\U200B.Other", "the rest") #
col <- c("XBB.1.5*"="#CC5500", "XBB\U200B.1.16*" = "#00eeff", "XBB\U200B.Other"=pal["XBB"]) #define custom color for XBB here because otherwise it will be black cuz recombinant.
...
We first show this growth of XBB.1.5\*, XBB.1.16\*, or XBB.Other, relative to the remaining strains, which consist predominantly of BQ.\*. Left plot: y-axis is the proportion of sub-lineages BQ., XBB.1.5\*, and XBB.Other relative to the remaining strains; right plot: y-axis describes the logit function, log(freq(XBB.1.5\*, XBB.1.16\*, or XBB.Other)/freq(the rest)), which gives a straight line whose slope is the selection coefficient if selection is constant over time (see methods).
