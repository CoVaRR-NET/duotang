...
sublineage_kp1 <- getStrictoSubLineages("KP.1*",meta)

sublineage_jn1 <- sublineages_XBB[!sublineage_jn1 %in% c(sublineage_kp1)] #XBB Other
...
sublineages_NonXBB<-setAll[!setAll %in% c(sublineages_XBB, sublineage_jn1, sublineage_kp1)] #the rest
...
# 
mutants = list(sublineages_XBB, sublineage_kp1 ,sublineages_NonXBB)
mutantNames = list("XBB", "KP.1*","BA.2.Other",  "JN.1*") #
col <- c("XBB"=pal["XBB"], "KP.1*" = "#00eeff","BA.2.Other*"="#CC5500") #define custom color for XBB here because otherwise it will be black cuz recombinant.
