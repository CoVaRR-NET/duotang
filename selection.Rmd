...
sublineages_XBBOther <- sublineages_XBB[!sublineages_XBB %in% c(sublineages_XBB15)] #XBB Other
...
Left plot: y-axis is the proportion of sub-lineages EG.5\*,  XBB.1.5\*, XBB.Other, and non-XBB. Right plot: y-axis describes the logit function, log(freq(non-XBB\*, XBB.1.16\*, or XBB.Other)/freq(XBB.1.5)), which gives a straight line whose slope is the selection coefficient if selection is constant over time (see methods).
...
plotCaseCountSelection <- function(caseCountData, selectionEstimateObject, saveToFile=F){
   # caseCountData <- caseData$ON
   # selectionEstimateObject<- selectionEstimateFits$ON
  # 
  # view(caseCountData)
  filename=NA
