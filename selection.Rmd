...
mutantNames = list("XBB.Other", "Non-XBB", "XBB.1.5*", "EG.5*") #
col <- c("XBB.Other"=pal["XBB"],"XBB.1.5*" = "#00eeff","Non-XBB*"="#CC5500") #define custom color for XBB here because otherwise it will be black cuz recombinant.
