...
mutants = list(sublineages_XBB15, sublineages_EG5, sublineages_XBBOther )
...
mutantNames = list("XBB.1.5*", "EG.5*", "XBB.Other", "The Rest") #
col <- c("XBB.1.5*"="#CC5500", "EG.5*" = "#00eeff", "XBB.Other"=pal["XBB"]) #define custom color for XBB here because otherwise it will be black cuz recombinant.
