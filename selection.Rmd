...
sublineage_LP8 <- getStrictoSubLineages("LP.8*",meta)
sublineage_LP8 <- sublineage_LP8[!sublineage_LP8 %in% c(sublineage_NB, sublineage_XFG)]
...
sublineages_other<-setAll[!setAll %in% c(sublineage_NB, sublineage_XFG, sublineage_LP8)] #the rest

reference = sublineage_LP8
...
mutants = list(sublineage_NB, sublineage_XFG, sublineages_other)
mutantNames = list("NB*", "XFG*","Others",  "LP.8*") #
col <- c("NB*"=pal["XBB"], "XFG*" = "#00eeff","Others"="#CC5500") #define custom color for XBB here because otherwise it will be black cuz recombinant.
