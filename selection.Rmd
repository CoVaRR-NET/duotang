...
sublineage_NB <- getStrictoSubLineages("NB*",meta)
sublineage_XFG <- getStrictoSubLineages("XFG*",meta)
sublineage_PQ <- getStrictoSubLineages("PQ*",meta)
sublineage_NB <- c(sublineage_NB[!sublineage_NB %in% c(sublineage_PQ, sublineage_XFG)],"NB.1.8.1")
...
sublineages_other<-setAll[!setAll %in% c(sublineage_NB, sublineage_XFG, sublineage_PQ)] #the rest

reference = sublineage_XFG
...
mutants = list(sublineage_NB, sublineage_PQ, sublineages_other)
mutantNames = list("NB*", "PQ*","Others",  "XFG*") #
col <- c("NB*"=pal["XBB"], "PQ*" = "#00eeff","Others"="#CC5500") #define custom color for XBB here because otherwise it will be black cuz recombinant.
...
selectionEstimateFits[["ON"]]$plot1 = NULL
