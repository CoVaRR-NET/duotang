...
sublineage_KP <- sublineage_KP[!sublineage_KP %in% c(sublineage_KP3)]
...
sublineages_other<-setAll[!setAll %in% c(sublineage_jn1, sublineage_KP, sublineage_KP3)] #the rest
...
# 
mutants = list(sublineage_KP3, sublineage_KP ,sublineages_other)
mutantNames = list("KP.3*", "KP.Others*","BA.2.Others",  "JN.1*") #
col <- c("KP.3*"=pal["XBB"], "KP.Others*" = "#00eeff","BA.2.Others"="#CC5500") #define custom color for XBB here because otherwise it will be black cuz recombinant.
