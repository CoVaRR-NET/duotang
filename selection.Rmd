...
Currently, the major group of SARS-CoV-2 lineages circulating are BA.2.86\* variants, particularly JN.1 and its descendants. Thus, at the broad scale, we are currently track the frequencies of JN.1\* descendants other than KP.1\*, KP.1\* descendants, XBB descendants and other BA.2 lineages (mainly BA.2.86 lineages not in JN.1\*).
