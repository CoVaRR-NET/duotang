...
sublineages_other<-setAll[!setAll %in% c(sublineage_KP_other, sublineage_MC, sublineage_KP3, sublineage_KP)] #the rest
...
# 
mutants = list(sublineage_MC, sublineage_KP_other, sublineages_other)
mutantNames = list("MC.*", "KP.Others*","Others",  "KP.3*") #
col <- c("MC.*"=pal["XBB"], "KP.Others*" = "#00eeff","Others"="#CC5500") #define custom color for XBB here because otherwise it will be black cuz recombinant.
