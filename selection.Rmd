...
sublineage_MC <- getStrictoSubLineages("MC.*", meta)[-2] #if CI estimation fails after all the checks (i.e. reasonable number of samples, and time), remove the root lineage in the mutant group. i.e. remove MC (AKA KP.3.1.1) from the mutant group. 
