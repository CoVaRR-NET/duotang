...
setAll=setAll[!setAll %in% c(sublineages_EG5, sublineages_XBB15, sublineages_XBBOther)] #the rest
...
mutants = list(sublineages_XBB15, sublineages_XBBOther, sublineages_EG5 )
...
mutantNames = list("XBB.1.5*", "XBB.Other",  "EG.5*", "The Rest") #
col <- c("XBB.1.5*"="#CC5500",  "XBB.Other"=pal["XBB"],"EG.5*" = "#00eeff") #define custom color for XBB here because otherwise it will be black cuz recombinant.
...
plotCaseCountSelection <- function(caseCountData, selectionEstimateObject, saveToFile=F){
  # caseCountData <- caseData$BC
  # selectionEstimateObject<- selectionEstimateFits$BC
  # 
  # view(caseCountData)
  filename=NA
