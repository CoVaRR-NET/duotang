...
Currently, the major group of Omicron lineages circulating are XBB.\* variants, including HV.1\*, as well as BA.2\* variants, particularly JN.1 and other BA.2.86 descendants. At the broad scale, we now track the frequencies of HV.1\*, XBB.Other, JN.1 and and BA.2.Other. 
