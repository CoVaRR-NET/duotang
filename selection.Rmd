...
mutantNames = list("KP.3*", "KP.Others*","Others",  "JN.1*") #
col <- c("KP.3*"=pal["XBB"], "KP.Others*" = "#00eeff","Others"="#CC5500") #define custom color for XBB here because otherwise it will be black cuz recombinant.
