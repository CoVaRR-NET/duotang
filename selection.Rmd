...
#startpar <- list(p=c(0.5, 0.05, 0.01), s=c(0.05, 0.05, 0.01))
...
#sublineages_XBBOther <- sublineages_XBB[!sublineages_XBB %in% sublineages_XBB15] #XBB Other

setAll=setAll[!setAll %in% c(sublineages_BQ, sublineages_XBB)] #the rest
#setAll=setAll[!setAll %in% c(sublineages_BQ, sublineages_XBB15, sublineages_XBBOther)] #the rest
...
#mutants = list(sublineages_BQ, sublineages_XBB15, sublineages_XBBOther )
#mutantNames = list("BQ*", "XBB.1.5*", "XBB.Other", "the rest") #
#col <- c(pal["Omicron BQ"], "Other XBB"=pal["XBB"], "XBB.1.5*"="#CC5500") #define custom color for XBB here because otherwise it will be black cuz recombinant.
