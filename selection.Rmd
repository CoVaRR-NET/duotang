...
## Selection trends by variant {.tabset .tabset-fade}  
...
## Case count trends by variant {.tabset .tabset-fade}
...
# Fastest growing lineages in Canada {.tabset .tabset-fade}
...
## BA.2 sublineages selection {.tabset .tabset-fade}
...
```{r, warning=FALSE, message=FALSE, echo = FALSE, fig.height=5, fig.width=5, warning=FALSE, out.width="33%", results='asis', dpi=50}
...
## BA.5 sublineages selection {.tabset .tabset-fade}
