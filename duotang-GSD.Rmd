...
---
title: |
  ![Duotang - GSD](img/CoVaRR-Net_Logo-600.png){width=1lm}
subtitle: "Duotang - GSD, a genomic epidemiology analyses and mathematical modelling notebook for GSD data"
author: "Pillar 6"
output:
  html_document:
    keep_md: true
...
tmp=apply(all.regions,1,function(reg){
  ...
  if(nV!=0){
    print((plot_growing_lineage(paramselectedV[1:nV])))
  }else{
    cat("![<img height=\"100\"/>](../img/NotEnoughData.jpg)")
  }
  cat("\n\n")})
...
```{r selection, child="selection-sandbox.Rmd"}
```
