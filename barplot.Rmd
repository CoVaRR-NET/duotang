...
dat <- lapply(unique(meta1$province), function(x) {
  tab <- as.data.frame.matrix(table(meta1$week[meta1$province==x], meta1$pango.group[meta1$province==x]))
...
r2d3(data=toJSON(dat), script="js/barplot.js", container="div", elementId="barplot-element")
```
