...
plot_selection_estimator3("Canada (no AB)",startdate,name1,name2,name3)
```
...
plot_selection_estimator3("British_Columbia",startdate,name1,name2,name3)
```
...
plot_selection_estimator3("Saskatchewan",startdate,name1,name2,name3)
```
...
plot_selection_estimator2("Quebec",startdate,name1,name2)
```
