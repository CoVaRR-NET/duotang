...
# Sys.setenv(RETICULATE_PYTHON = "/media/rp/partition4data/Dropbox/Raph/covarrnet/python_R_env/bin/python")#python path that works for Raphael
...
In the tree trimming process, all BA.2 genomes were removed from the dataset, as they were flagged as outliers during the calculation of the molecular clock.
