...
Sequence collection, generation, and distribution: Canadian laboratories across the country are making these data publicly available. Below is a complete list of lab authors. 
...
#zip /media/rp/partition4data/Dropbox/Raph/covarrnet/essai2/CoVaRRNet_pillar6notebook/data_needed/metadata_CANall_$date.zip metadata_CANall_$date.csv
...
metaCANall$pango.group[grepl("B\\.1\\.351", metaCANall$Pango_lineage)] <- "Beta"
...
metaCANall$pango.group[grepl("C\\.37|C\\.37\\.1", metaCANall$Pango_lineage)] <- "Lambda"
...
metaCANall$pango.group[grepl("B\\.1\\.621", metaCANall$Pango_lineage)] <- "Mu"
...
A list of defining mutations of Omicron sub-lineages is found here: https://github.com/PoonLab/gromstole/tree/master/lineages (Art Poon's lab).
...
* PHAC/NML (https://health-infobase.canada.ca/covid-19/epidemiological-summary-covid-19-cases.html)
* various PT PH websites (e.g. INSPQ https://www.inspq.qc.ca/covid-19/donnees/)  
