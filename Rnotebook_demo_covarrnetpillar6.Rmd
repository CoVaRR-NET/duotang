...
#barplot(table(meta1$pango.group, meta1$week), 
#        col=pal[match(levels(meta1$pango.group), names(pal))], 
#        border=NA)
...
r2d3(dat, script="js/streamgraph.js")
```
...
plt
#saveWidget(plt, file="streamgraph.html")
```
