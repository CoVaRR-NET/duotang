...
## Evolution of omicron sublineages in Canada  {.tabset}  
...
# Under development and aspirational
...
Logit plots (right panels) show $$log(p_i(t)/p_{ref}(t))$$ relative to a given reference genotype (here BA.1), which gives a line whose slope is the strength of selection $s_i$. Changes in slope indicate changes in selection on a variant (e.g., see [Otto et al.](https://mast.queensu.ca/~tday/pdf/Otto2021.pdf)).
