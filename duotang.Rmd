...
for(row in 1:nrow(epidataCANall)) {
  ...
  if(nrow(subdf)!=0){
    ...
    epidataCANall[nextrow,"previousvalue"]=epidataCANall[row, "numtotal"]
  }
}
epidataCANall$numtoday=epidataCANall$numtotal-epidataCANall$previousvalue
...
showlineages <- showlineages %>% filter(n>200)
