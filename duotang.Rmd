...
meta <- read.csv(gzfile("../temp/duotang/data_needed/virusseq.metadata.csv.gz"),sep="\t")
meta$province <- meta$geo_loc_name_state_province_territory

#Select on ly the column we want to use later
columnlist=c("fasta_header_name", "province", "host_gender", "host_age_bin", "sample_collection_date", 
                      "sample_collected_by", "purpose_of_sampling", "purpose_of_sequencing","lineage", "raw_lineage")
...
meta$pango_group <- create.pango.group(VOCVOI)
