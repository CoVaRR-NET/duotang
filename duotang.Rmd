...
**[NOTE: No data update this week but selection plots are now versus XBB.1.5., an XBB diversity tree was added, the RTT plots are now interactive, and there is a new data source for Ontario case counts.]**
...
* XBB.1.5.7, XBB.1.5.13, XBB.1.1.15, XBB.1.16, XBB.1.9.1, XBB.1.9.2 and subvariants with mutations of note like: 
  ...
  + S:Q613H
  + _S:E180V_
  + _S:T478R (aka S:K478R - the S:T478K mutation occurred first)_
  + _ORF1a:L3829F (aka NSP6_L260F; but previously very prevalent)_
  + _ORF1b:D1746Y (aka NSP14_D222Y)_
  + _ORF9b:I5T (note its a synonymous mutation in the overlapping N gene)_
  + _ORF9b:N55S (synonymous mutation in N)_
