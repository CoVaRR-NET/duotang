...
* CA.1
* XBB
* BF.7, containong immune evasion mutationS:R346T 
* and other variants with immune evasion mutations
...
ggplot(d, aes(x=lineage, y=sel_coeff, colour=sequence_count))+
geom_point(size=4)+
