...
latelineage_pangotree <- makepangotree(unique(meta$raw_lineage[meta$sample_collection_date > max(meta$sample_collection_date) - days(60) ]))
...
### BA.1
#### Sublineage BA.1 until 2022 June 1st
...
rarelineages_names=plot.subvariants(sublineage=set,maxdate=as.Date("2022-06-01"))
rarelineages_names=plot.subvariants(sublineage=set,maxdate=as.Date("2022-06-01"),scale=T)
plotted=set
...
### early BA.2
#### Sublineage BA.2 until 2022 August 1st
...
### late BA.2
#### Sublineage BA.2 after 20220 August 1st
...
### BQ
#### Sublineage BQ
```{r subtype plotter BQ, figures-side, message=FALSE, warning=FALSE, echo = FALSE, fig.width=5, fig.height=5, fig.show="hold", out.width="50%"}
set=getStrictoSubLineages("BQ*",meta)
rarelineages_names=plot.subvariants(sublineage=set)
rarelineages_names=plot.subvariants(sublineage=set,scale=T)
plotted=c(plotted,set)
printest(rarelineages_names)
...
### Other BA.5
#### Sublineage BA.5 without BA.5.1\*, BA.5.2\*, and BQ\*
...
set=set[!set %in% plotted]
rarelineages_names=plot.subvariants(sublineage=set,mindate=max(meta$sample_collection_date)-days(100))
rarelineages_names=plot.subvariants(sublineage=set,mindate=max(meta$sample_collection_date)-days(100),scale=T)
```
The grey zone represent rare lineages (not in top 15) : `r rarelineages_names`
