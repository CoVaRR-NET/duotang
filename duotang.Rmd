...
name1 <- unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.1$|B\\.1\\.1\\.529\\.1\\.", meta$rawlineage)]) # "BA.1"
name2 <- unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.2$|B\\.1\\.1\\.529\\.2\\.", meta$rawlineage)])  # "BA.2" 
name3 <- unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.4$|B\\.1\\.1\\.529\\.4\\.", meta$rawlineage)])  # "BA.4" 
name4 <- unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.5$|B\\.1\\.1\\.529\\.5\\.", meta$rawlineage)])  # "BA.5" 
...
rarelineages_names=plot.subvariants(sublineage=c(name1))
rarelineages_names=plot.subvariants(sublineage=c(name1),scale=T)
```
...
rarelineages_names=plot.subvariants(sublineage=c(name2))
rarelineages_names=plot.subvariants(sublineage=c(name2),scale=T)
```
The grey zone represent rare lineages (not in top 15) : `r rarelineages_names`
...
rarelineages_names=plot.subvariants(sublineage=c(name3))
rarelineages_names=plot.subvariants(sublineage=c(name3),scale=T)
```
The grey zone represent rare lineages (not in top 15) : `r rarelineages_names`
...
rarelineages_names=plot.subvariants(sublineage=c(name4))
rarelineages_names=plot.subvariants(sublineage=c(name4),scale=T)
```
The grey zone represent rare lineages (not in top 15) : `r rarelineages_names`
...
#name1 <- "BA.2"; name2 <- "BA.4"; name3 <- "BA.5"
name1 <- unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.2$|B\\.1\\.1\\.529\\.1\\.2\\.", meta$rawlineage)])  # "BA.2" 
name2 <- unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.4$|B\\.1\\.1\\.529\\.1\\.4\\.", meta$rawlineage)])  # "BA.4" 
name3 <- unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.5$|B\\.1\\.1\\.529\\.1\\.5\\.", meta$rawlineage)])  # "BA.5" 
...
startdate<-as.Date("2022-04-01") #Using a later date with less sampling noise
...
Here we show the trends of the various BA.4# sublineages over time, relative to the frequency of BA.4 by itself (shown for sublineages with at least 50 (Canada) or 20 (provinces) cases). Note that these plots are not necessarily representative of trends in each province and that mixing of data from different provinces may lead to  shifts in frequency that are not due to selection.
...
Here we show the trends of the various BA.5# sublineages over time, relative to the frequency of BA.5 by itself (shown for sublineages with at least 50 (Canada) or 20 (provinces) cases). Note that these plots are not necessarily representative of trends in each province and that mixing of data from different provinces may lead to  shifts in frequency that are not due to selection.
