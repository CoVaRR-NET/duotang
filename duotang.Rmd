...
***[Note a new analysis is now available below of a time tree limited to XBB and its descendents]***

XBB.1.5 continues to grow steadily and significantly. Some other select variants with the S:F486P mutation are also showing growth in some regions such as CJ.1 and XBF. BQ.1.1 is increasing again in some regions of Canada along with some other select BQ.1 subvariants, BW.1.1, and CH.1.1. Differences between some provinces continue - see also the evolving plots below of “Fastest growing lineages in Canada”, per province.
...
* XBB.1, XBB.1.5, XBB.1.9.1, XBB.1.12, XBB.6.1 and subvariants with S:F486P (or other mutations of note like S:Y453F)
...
* …and other variants with mutations associated with immune evasion or higher binding affinity to the human ACE2 receptor (examples: S:R346T, S:K147N, S:Y453F, S:F486P), particularly those variants with sets of immune evasive mutations of interest.
