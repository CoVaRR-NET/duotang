...
### metadata and trees
MLtree_sub1 <- read.tree("./data_needed/sample1.filtered.nwk")
...
p1 <- ggtree(ttree_sub1, mrsd = as.Date(mrdate)) %<+%
  metasub1[,c("specimen.collector.sample.ID", "pango.group"), drop=FALSE] + 
  ...
  scale_x_continuous(breaks = c(
    Date2decimal("2020-01-01"), Date2decimal("2020-03-01"), 
    Date2decimal("2020-06-01"), Date2decimal("2020-09-01"),
    Date2decimal("2021-01-01"), Date2decimal("2021-03-01"), 
    Date2decimal("2021-06-01"), Date2decimal("2021-09-01")
    ),
    labels = c(format(as.Date("2020-01-01"), "%Y"),
               format(as.Date("2020-03-01"), "%b"), 
               format(as.Date("2020-06-01"), "%b"), 
               format(as.Date("2020-09-01"), "%b"),
               format(as.Date("2021-01-01"), "%Y"),
               format(as.Date("2021-03-01"), "%b"), 
               format(as.Date("2021-06-01"), "%b"), 
               format(as.Date("2021-09-01"), "%b"))
    ) +  
