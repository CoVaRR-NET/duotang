...
---
title: |
  ![](./data_needed/CoVaRR-Net_Logo-600.png){width=1lm}  
...
VOCVOI <- data.frame(
  ...
  pattern=c('^B\\.1\\.1\\.7|^Q\\.', '^B\\.1\\.351', '^P\\.', 
            ...
            '^C\\.37|^C\\.37\\.1',
            '^B\\.1\\.1\\.529|^BA\\.1$|^BA\\.1\\.1[0-9]$|BA\\.1\\.[2-9]$', 
            '^BA\\.1\\.1$|^BA\\.1\\.1\\.[0-9]+$', 
            '^BA\\.2', 
            '^B\\.1\\.621', 
            '^A\\.23\\.1', '^B\\.1\\.438\\.1'),
...
### metadata and trees
MLtree_sub1 <- read.tree("./data_needed/sample3.rtt.nwk")
ttree_sub1 <- read.tree("./data_needed/sample3.timetree.nwk")
require(lubridate)
