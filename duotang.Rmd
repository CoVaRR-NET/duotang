...
fit1 <- fit.rtt("./data_needed/sample1.filtered.nwk", plot=TRUE)
```
...
fit2 <- fit.rtt("data_needed/sample2.filtered.nwk", plot=FALSE)
fit3 <- fit.rtt("data_needed/sample3.filtered.nwk", plot=FALSE)
...
ggplot(sec.frame, aes(x=Lineage, y=est, fill=rep)) + 
