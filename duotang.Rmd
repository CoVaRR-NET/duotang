...
VOCVOI <- data.frame(
  name=c('Alpha', 'Beta', 'Gamma',
         ...
         'Omicron BA.4', 'Omicron BA.5', 'Omicron BA.2',
         'Mu', 'A.23.1', 'B.1.438.1'),
...
for(row in 1:nrow(epidataCANall)) {
  ...
  if(nrow(subdf)!=0){
    ...
    epidataCANall[nextrow,"previousvalue"]=epidataCANall[row, "numcases_total"]
  }
}
epidataCANall$numtoday=epidataCANall$numcases_total-epidataCANall$previousvalue
...
name1 <- unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.1$|B\\.1\\.1\\.529\\.1\\.[2-9]|B\\.1\\.1\\.529\\.1\\.1[0-9]", meta$rawlineage)])
name2 <- unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.1\\.1$|B\\.1\\.1\\.529\\.1\\.1\\.", meta$rawlineage)])  #"B\\.1\\.1\\.529.1.1"
name3 <- unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.2", meta$rawlineage)])  # "BA.2" 
