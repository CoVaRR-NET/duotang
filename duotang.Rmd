...
***[Note: Variant proportions may change notably in upcoming updates, due to the recent holiday season impacting data collection.]***

BQ.1, BQ.1.1 and some associated BQ variants are dominant at this time in Canada. Other variants, including XBB.1.5, are showing notable growth internationally, and have been more recently detected in Canada, with low numbers to date. XBB.1.5 has the spike mutation S:F486P, which is of note as it potentially increases immune evasion while also improving binding with the human ACE2 receptor. S:F486P is a “two-step mutation”, requiring two changes from the Wuhan ancestor to transition from the amino acid phenylalanine (F) to proline (P) and is now observed in XBB.1.5 plus some BA.2/BA.2.75-based variants and other unrelated BA.5-based variants. Some intermediate variants with a serine (S) have also recently been observed, including in Canada, that may lead to more variants with S:F486P.  Variants not yet classified and/or not yet in Canada that are associated with significant new outbreaks in other countries are also being monitored, including by mutation-based analysis.
...
* XAY.2 (has Delta's S:L452R mutation plus the S:486P mutation)
