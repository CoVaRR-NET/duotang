...
author: "Pillar 6"
date: '`r format(as.Date(VirusSeq_release), "%B %d, %Y")`'
output:
  html_document:
    keep_md: true
    code_folding: hide
...
meta <- meta[,c("fasta.header.name","sample.collection.date", "province", "rawlineage", "lineage")]
