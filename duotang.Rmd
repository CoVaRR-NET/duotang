...
* XBB
* BF.7
* and other variants with immune evasion mutations (e.g: S:R346T)
...
print(rarelineages_names)
print('BA.5.2.7(1), BF.13(1), BF.14(1), BF.15(1), BF.3.1(1), BA.5.1.12(2), BA.5.2.4(2), BA.5.3.4(2), BA.5.1.9(3), BA.5.2.6(3), BE.2(3), BA.5.9(4), BA.5.5.1(6), BA.5.6.1(6), BA.5.3.3(7), BF.3(7), BA.5.1.8(8), BE.1.2(9), BF.1.1(10), BF.6(11), BA.5.1.4(12), BF.11(12), BA.5.6.2(17), BA.5.3(20), BF.2(21), BA.5.1.5(28), BF.12(30), BA.5.3.2(36), BA.5.1.6(60), BA.5.10(76), BK.1(78), BF.8(102), BA.5.1.3(103), BA.5.2.3(119), BA.5.1.10(123), BF.7(128), BE.3(132), BF.4(133), BA.5.2.2(135), BA.5.8(165), BA.5.1.2(202)')
```
The grey zone represent rare lineages (not in top 15) : `r rarelineages_names`
...
```{r overview of the selection estimator plot, fig.retina = 2, warning=FALSE}
...
#test <- meta %>% filter(!is.na(sample.collection.date),sample.collection.date >= startdate) %>% dplyr::count(rawlineage)

d = plot_growing_lineage(r)
...
showlineages <- sublineagedata %>% filter(geo_loc_name..state.province.territory.=="New Brunswick"|geo_loc_name..state.province.territory.=="Nova Scotia" | geo_loc_name..state.province.territory.=="Newfoundland and Labrador")
source("scripts/plot_selection_estimator_2type.R")
showlineages <- showlineages %>% filter(lineage!="BA.5.2.22")
showlineages <- showlineages %>% filter(lineage!="BF.7")
showlineages <- showlineages %>% filter(lineage!="BA.5.1")
multi.plot.selection(showlineages,"East provinces (NL+NS+NB)",namereference,20)
```
