...
```{r geenral settings for selection estimator, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.show="hold", fig.width=5, warning=FALSE, out.width="33%", results='asis'}
...
#function to avoid repeating the same lines
multi.plot.selection <- function(sublineagedata,region, name1,maxnumberofsequence) {
  showlineages <- sublineagedata %>%
    ...
    filter(lineage!=namereference)#We'll use BA.2 as the reference and drop it:
  
  includelineages <- as.list(showlineages$lineage)
  if (length(includelineages)<1){print("Not enough data available")}
  else {
    #test=unique(meta$lineage[grepl("B\\.1\\.1\\.529\\.2.3$|B\\.1\\.1\\.529\\.2\\.3.", meta$rawlineage)])
    #plot.selection(region=region, startdate=startdate, reference=name1, mutants=test, startpar=startpar2) 
    for (name2 in includelineages) {
      plot.selection(region=region, startdate=startdate, reference=name1, mutants=name2, startpar=startpar2) 
    }
  }
}
...
### Canada
#### Canada (n>50)
```{r function and selection estimator Canada, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.show="hold", fig.width=5, warning=FALSE, out.width="33%", results='asis'}
...
```{r function and selection estimator BC, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.show="hold", fig.width=5, warning=FALSE, out.width="33%", results='asis'}
...
### Ontario
#### Ontario (n>20)
```{r function and selection estimator ON, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.show="hold", fig.width=5, warning=FALSE, out.width="33%", results='asis'}
...
### Quebec
#### Quebec (n>20)
```{r function and selection estimator QC, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.show="hold", fig.width=5, warning=FALSE, out.width="33%", results='asis'}
...
### Saskatchawan
#### Saskatchawan (n>20)
```{r function and selection estimator SK, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.show="hold", fig.width=5, warning=FALSE, out.width="33%", results='asis'}
...
### Manitoba
#### Manitoba (n>20)
```{r function and selection estimator MN, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.show="hold", fig.width=5, warning=FALSE, out.width="33%", results='asis'}
...
```{r function and selection estimator NB+NF+NS, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.show="hold", fig.width=5, warning=FALSE, out.width="33%", results='asis'}
