...
Finally, once the inferred case counts ($n_i(t)$) of each lineages are calculated, we take the last two days of data from the smooth spline times lineage frequency curve to get $n_i[t]$ and $n_i[t-1]$, from which the growth rate of that lineage is estimated as $$r_i = log10(\frac{n_i[t]}{n_i[t-1]})$$.
