...
VOCVOI$pattern <- gsub("([\\*])$",".*",VOCVOI$pattern)
VOCVOI$pattern <- gsub("([\\*])\\|",".*|",VOCVOI$pattern)
VOCVOI$pattern[4]="^(?!B\\.1\\.617\\.2\\.25$|^B\\.1\\.617\\.2\\.25\\..*|B\\.1\\.617\\.2\\.27$|^B\\.1\\.617\\.2\\.27\\..*)(B\\.1\\.617\\.2|B\\.1\\.617\\.2\\.[0-9\\.]+)$"
...
*BA.5.2.1
*BA.5.6
*Variants with mutation S:R346T (includes some BA.5.2.1 and BA.4.6)
