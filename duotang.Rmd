...
meta <- meta %>% rowwise() %>% mutate(raw_lineage = ifelse(raw_lineage == "XEE", "JN.1", raw_lineage)) %>% mutate(raw_lineage = ifelse(raw_lineage == "XEF", "JN.1", raw_lineage) )%>% mutate(raw_lineage = ifelse(raw_lineage == "XEM", "JN.1", raw_lineage) )%>% mutate(raw_lineage = ifelse(raw_lineage == "XEL", "JN.1", raw_lineage) )%>% mutate(raw_lineage = ifelse(raw_lineage == "XEK", "JN.1", raw_lineage) )%>% mutate(raw_lineage = ifelse(raw_lineage == "XEP", "JN.1", raw_lineage) )%>% mutate(raw_lineage = ifelse(raw_lineage == "XEJ", "JN.1", raw_lineage) )
