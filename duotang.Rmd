...
The proportion of cases that contain the mutation S:F486P continues to grow in Canada and is now over 85%. Of these variants, XBB.1.5 still predominates at over 60% of samples, but other lineages that contain this 486P mutation are now growing. These include XBB.1.9.1 and XBB.2.3 - the latter has also the mutation S:P521S that could increase human ACE2 receptor binding/infectivity. XBB.1.16 with 486P is notably growing as well and also has the mutation S:T478R (aka S:K487R depending on your reference) that has been shown to increase infectivity versus XBB.1.5. More differences in regions are noted, with for example CH.1.1 variants predominating more in the maritimes, while XBB.1.16 is most notable in Ontario.

**Variants of current interest**, due to their current/potential growth advantage, mutations of potential functional significance, or spread in other countries (note that some may not yet be detected in Canada). Bold italics denote those added since the last update of this summary, but they do not necessarily represent the primary variants of interest - the latter are usually highlighted in the text above):

* DV.1 (BA.2.75 descendant)
* EG.1 (an XBB.1.9.1 subvariant)
* EK variants (subvariants of XBB.1.5.13)
* **_Multiple XBB.1.5 subvariants including XBB.1.5.15_**, XBB.1.16, XBB.1.9.1, XBB.1.9.2
* **_XBB.2.3 (has mutation S:P521S that could increase human ACE2 receptor binding/infectivity)_**
* **_XBC.1.6 (a “Deltacron” variant - recombinant lineage of BA.2 and B.1.617.2)_**
* and subvariants with mutations of note like:
  + S:E180V
  + S:F486P
  + S:Y453F
  + **_S:P521S_**
  + S:Q613H
  + S:T478R (aka S:K478R - the S:T478K mutation occurred first)
