...
meta$month <- cut(meta$sample_collection_date, 'month')
...
hab=hab[order(hab)]
months=unique(as.character(meta$months))
months=months[order(months)]
presetColors=data.frame(name=c("other",VOCVOI$name,hab,months), color=c("#777777",VOCVOI$color,rev(hcl.colors(length(hab)-1, "Red-Blue")),"#777777",hcl.colors(length(months), "Red-Blue")))
