...
#for predicted lineages with out numbered subvariant, we append it on so it doesnt break things
meta <- meta %>% rowwise() %>% mutate(raw_lineage = ifelse(grepl(".[0-9]", raw_lineage), raw_lineage, paste0(raw_lineage,".1")))
