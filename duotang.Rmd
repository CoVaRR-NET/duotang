...
**NOTE:** Due to the large amount of visualizations provided in this notebook, this page may take up to 30 seconds to load completly. We applogize for the inconvenience. 
...
**[NOTE: The order of some analyses below has changed. Frequency barplots now include a default tab showing the last 120 days.]**

XBB.1.5, combined with its subvariants and other variants with the mutation S:F486P (like XBF, and XBB.1.9.1 which may have a further fitness advantage), are still collectively growing in all regions of Canada. Some other select subvariants are also increasing in some regions of Canada, but not as significantly or with lower numbers. Differences between some provinces continue - see the evolving plots below of “Fastest growing lineages in Canada”, and “case count trends by variant”, per province.

**Variants of current interest**, due to their current/potential growth advantage, mutations of potential functional significance, or spread in other countries (note that some of these are not yet detected in Canada. Italics are variants of interest added since the last update of this summary):

* BM.1.1.1
* BM.2 (high predicted affinity for the human ACE2 receptor)
* BN.1* subvariants due to high predicted immune evasion
* BQ.1.8 with S:F486P and S:L452R (seen recently in Ontario and _now also in other provinces_)
* BQ.1* select new descendants, particularly BQ.1.1.5 with S:Y453F
* BW.1, BW.1.1, BW.1.1.2 (descendants of BA.5.6, with S:F486A)
* CH.1.1 descendants (CH.1.1 is descendant of BM which is BA.2.75.3 with S:L452R) and sublineages
...
* XBB.1, XBB.1.5, XBB.1.5.13, XBB.1.9.1, _XBB.1.9.2_, XBB.1.10, XBB.1.12, _XBB.1.16_, XBB.6.1 and subvariants with S:F486P (or other mutations of note like S:Y453F)
* XBF subvariants (BA.5.2/CJ.1 recombinant; have S:F486P and immune evasion like XBB.1.5)
* XBL (has S:F486P and immune evasion like XBB.1.5)
