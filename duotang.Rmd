 ...
 * CH.1.1 (descendant of BM which is BA.2.75.3) and some sublineages recently detected in Canada such as CH.1.1.3
...
#selectionEstimateFits[["BC"]]  <- (sub.plot.selection.estimate(region="British Columbia",maxdate=maxdate))
