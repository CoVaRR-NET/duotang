...
test <- varmeta1 %>% group_by(lineage) %>% count()
a= test %>% filter(n<0.0001*nrow(varmeta1))
print(nrow(a))
print(nrow(test))
...
plot.subvariants(sublineage=c(name4))
plot.subvariants(sublineage=c(name4),scale=T)
```
