...
* XBB.1, XBB.1.5, XBB.1.9.1, XBB.6.1 and subvariants with S:F486P (or other mutations of note like S:Y453F)
...
* …and other variants with mutations associated with immune evasion or higher binding affinity to the human ACE2 receptor (examples: S:R346T and S:F486P), particularly those variants with sets of immune evasive mutations of interest.
