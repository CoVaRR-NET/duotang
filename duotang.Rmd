...
* CA.1
* XBB
* BF.7, containing immune evasion mutation S:R346T 
...
plot_growing_lineage <- function(r){
  ...
  ggtitle("Recently designated lineages showing most growth")+ labs(x="", y= paste("growth advantage (% per day) relative to", namereference, "and 95% confidence interval"))+theme_bw()
  plot(p)
  return(d)
}
