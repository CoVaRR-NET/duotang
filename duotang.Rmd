...
library(r2d3)
r2d3(meta1, script="js/barplot.js")
```
...
plot.variants <- function(region='Canada', scaled=FALSE) {
  if (region=='Canada') {
    ...
    meta2 <- meta1[meta1$geo_loc_name..state.province.territory.==region, ]
...
Sequence counts for all Canadian data in VirusSeq Portal, up to `r epidate`. Case counts over time (rolling 7 day average) are added in green for comparison, given that sequencing coverage varies over time.  
