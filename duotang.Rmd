...
plot.selection.estimate(region="Canada (no AB)", startdate=startdate, startpar=startpar3,
                         reference=c("BA.1"), mutants=list("BA.1.1", "BA.2"), col=col)
```

### BC
#### British Columbia

```{r selection estimator BC, message=FALSE, warning=FALSE, echo = FALSE, fig.width=5,fig.height=5, fig.show="hold", out.width="50%", eval=FALSE}
plot.selection.estimate(region="British Columbia", startdate=startdate, startpar=startpar,
                         reference=c("BA.1"), mutants=list("BA.1.1", "BA.2"), col=col,
                        method="Nelder-Mead")
```
...
```{r selection estimator SK, message=FALSE , warning=FALSE, echo = FALSE, fig.width=5,fig.height=5, fig.show="hold", out.width="50%", eval=FALSE}
#plot_selection_estimator3("Saskatchewan",startdate,name1,name2,name3,col2,col3)
plot.selection.estimate(region="Saskatchewan", startdate=startdate, startpar=startpar,
                         reference=c("BA.1"), mutants=list("BA.1.1", "BA.2"), col=col)
```
...
```{r selection estimator QC, message=FALSE , warning=FALSE, echo = FALSE, fig.width=5,fig.height=5, fig.show="hold", out.width="50%", eval=FALSE}
#plot_selection_estimator2("Quebec", startdate, name1, name2, col2)
plot.selection.estimate(region="Quebec", startdate=startdate, startpar=startpar,
                         reference=c("BA.1", "BA.1.1"), mutants=list("BA.2"), col=col)
```
...
plot.selection.estimate(region="East provinces (NL+NS+NB)", startdate=startdate, 
                        startpar=startpar, reference=c("BA.1", "BA.1.1"), 
                        mutants=list("BA.2"), col=col)
```
