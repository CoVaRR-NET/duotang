...
for(col in columnlist){
  for(unknowntag in c("Undeclared","Not Provided","Restricted Access","Missing","Not Applicable"))
  meta[col][meta[col]==unknowntag] <- "Unknown"
}
...
meta$pango.group <- create.pango.group(VOCVOI)
...
latelineage_pangotree=makepangotree(unique(meta$rawlineage[meta$sample.collection.date>as.Date("2022-10-14") ]))
length(latelineage_pangotree)
...
fieldnames<- c("fasta.header.name", "province", "host.gender", "host.age.bin",
               "sample.collected.by", "purpose.of.sampling",
               "lineage", "pango.group","week")
