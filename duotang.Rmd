...
* BA.5.2.1
* BA.5.6
* Variants with mutations known to  evade antibodies, such as S:R346T (includes some BA.5.2.1 and BA.4.6, as well as BA.2.75.2 [Sheward et al.](https://www.biorxiv.org/content/10.1101/2022.09.16.508299v2))
...
```{r general settings for selection estimator}
...
## Selection estimation tables

Here we show all the subvariants with a positive selection estimate.

```{r overview of the selection estimator}
...
source("scripts/plot_selection_estimator_2type.R")
rba2=multi.plot.selection(sublineagedata,"Canada",namereference,50)
...
showlineages <- showlineages %>% filter(lineage!="BA.2.75")
...
rba4=multi.plot.selection(sublineagedata,"Canada",namereference,50)
...
rba5=multi.plot.selection(sublineagedata,"Canada",namereference,50)
