...
startpar <- list(p=c(0.5, 0.2, 0.05), s=c(0.0, 0.0, 0.1))
...
mltree <- read.tree("./data_needed/sample5.rtt.nwk")
ttree <- read.tree("./data_needed/sample5.timetree.nwk")
...
fit1 <- fit.rtt("./data_needed/sample5.rtt.nwk", plot=TRUE)

```


```{r}
fit2 <- fit.rtt("data_needed/sample6.rtt.nwk", plot=FALSE)
fit3 <- fit.rtt("data_needed/sample7.rtt.nwk", plot=FALSE)
```
